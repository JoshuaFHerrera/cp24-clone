...
const apiURL2 = `https://newsapi.org/v2/everything?q=sports&apiKey=${apikey}`;
...
function displaySports(articles) {
  ...
  cardImg6.src = articles[6].urlToImage;
  cardImg6.alt = articles[6].title;
  cardTitle6.textContent = articles[6].title;
  cardDesc6.textContent = articles[6].description;
  cardHref6.href = articles[6].url;
  ...
  cardImg7.src = articles[7].urlToImage;
  cardImg7.alt = articles[7].title;
  cardTitle7.textContent = articles[7].title;
  cardDesc7.textContent = articles[7].description;
  cardHref7.href = articles[7].url;
  ...
  cardImg8.src = articles[8].urlToImage;
  cardImg8.alt = articles[8].title;
  cardTitle8.textContent = articles[8].title;
  cardDesc8.textContent = articles[8].description;
  cardHref8.href = articles[8].url;
  ...
  cardImg9.src = articles[9].urlToImage;
  cardImg9.alt = articles[9].title;
  cardTitle9.textContent = articles[9].title;
  cardDesc9.textContent = articles[9].description;
  cardHref9.href = articles[9].url;
  ...
  cardImg10.src = articles[10].urlToImage;
  cardImg10.alt = articles[10].title;
  cardTitle10.textContent = articles[10].title;
  cardDesc10.textContent = articles[10].description;
  cardHref10.href = articles[10].url;
