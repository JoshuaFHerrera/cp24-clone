...
searchCTR.addEventListener("submit", async (event) => {
  ...
  if (input) {
    ...
    infoCard.innerHTML =
      '<span class="errorMessage">Sorry we couldn\'t find that city. Please try again.</span>';
  }
});
...
function displayInfo(data) {
  ...
  if ((weatherID >= 200 && weatherID <= 232) || weatherID == 504) {
    // thunderstorm and extreme rain
    ...
    infoCTR.style.backgroundSize = "cover";
    infoCTR.style.backgroundRepeat = "no-repeat";
  } else if (weatherID >= 500 && weatherID <= 503) {
    // heavy rain
    emojiDisplay.innerHTML = "🌧️";
    ...
    infoCard.style.background =
      "-moz-linear-gradient(98deg, rgba(144,136,136,1) 0%, rgba(224,236,244,1) 47%, rgba(63,154,214,1) 100%)";
    infoCard.style.background =
      "-webkit-linear-gradient(98deg, rgba(144,136,136,1) 0%, rgba(224,236,244,1) 47%, rgba(63,154,214,1) 100%)";
    infoCard.style.background =
      "linear-gradient(98deg, rgba(144,136,136,1) 0%, rgba(224,236,244,1) 47%, rgba(63,154,214,1) 100%)";
    infoCard.style.filter =
      'progid:DXImageTransform.Microsoft.gradient(startColorstr="#908888",endColorstr="#3f9ad6",GradientType=1)';
    ...
    infoCard.style.background =
      "-moz-linear-gradient(98deg, rgba(124,124,124,1) 0%, rgba(187,187,187,1) 62%, rgba(227,227,228,1) 96%)";
    infoCard.style.background =
      "-webkit-linear-gradient(98deg, rgba(124,124,124,1) 0%, rgba(187,187,187,1) 62%, rgba(227,227,228,1) 96%)";
    infoCard.style.background =
      "linear-gradient(98deg, rgba(124,124,124,1) 0%, rgba(187,187,187,1) 62%, rgba(227,227,228,1) 96%)";
    infoCard.style.filter =
      'progid:DXImageTransform.Microsoft.gradient(startColorstr="#7c7c7c",endColorstr="#e3e3e4",GradientType=1)';
    ...
    infoCard.style.background =
      "-moz-linear-gradient(180deg, rgba(22,22,22,1) 0%, rgba(112,110,110,1) 29%, rgba(255,255,255,1) 52%, rgba(132,132,132,1) 80%, rgba(57,57,57,1) 100%)";
    infoCard.style.background =
      "-webkit-linear-gradient(180deg, rgba(22,22,22,1) 0%, rgba(112,110,110,1) 29%, rgba(255,255,255,1) 52%, rgba(132,132,132,1) 80%, rgba(57,57,57,1) 100%)";
    infoCard.style.background =
      "linear-gradient(180deg, rgba(22,22,22,1) 0%, rgba(112,110,110,1) 29%, rgba(255,255,255,1) 52%, rgba(132,132,132,1) 80%, rgba(57,57,57,1) 100%)";
    infoCard.style.filter =
      'progid:DXImageTransform.Microsoft.gradient(startColorstr="#161616",endColorstr="#393939",GradientType=1)';
    ...
    infoCard.style.background =
      "-moz-linear-gradient(0deg, rgba(255,0,0,1) 0%, rgba(255,89,0,1) 43%, rgba(255,222,0,1) 100%)";
    infoCard.style.background =
      "-webkit-linear-gradient(0deg, rgba(255,0,0,1) 0%, rgba(255,89,0,1) 43%, rgba(255,222,0,1) 100%)";
    infoCard.style.background =
      "linear-gradient(0deg, rgba(255,0,0,1) 0%, rgba(255,89,0,1) 43%, rgba(255,222,0,1) 100%)";
    infoCard.style.filter =
      'progid:DXImageTransform.Microsoft.gradient(startColorstr="#ff0000",endColorstr="#ffde00",GradientType=1)';
